...
app.post("/api/users/:userId/salas", async (req, res) => {
...
app.delete("/api/users/:userId/salas/:salaId", async (req, res) => {
  try {
    const userId = req.params.userId
    const salaId = parseInt(req.params.salaId, 10);
...
app.get("/api/users/:userId/salas", async (req, res) => {
  try {
    const userId = req.params.userId;
...
app.get("/api/salas/:salaId/users", async (req, res) => {
  try {
    const salaId = parseInt(req.params.salaId, 10);
